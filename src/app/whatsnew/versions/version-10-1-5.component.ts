...
@Component({
  selector: 'version-10-1-5',
  styleUrls: ['./version-10-1-5.component.scss'],
  templateUrl: './version-10-1-5.component.html'
})
export class Version_10_1_5Component implements DynaComp {
  data: any;
  ...
  private enhancementUrl: string = 'https://www.ibm.com/support/knowledgecenter/SSNQFQ_10.1.5/spp/r_techchg_spp.html';
  ...
  goLearnMore(key: string) {
    console.log('Help URL: ' + this.help.getHelp('whatsnew-10-1-5-' + key));
    SharedService.openUrl(this.help.getHelp('whatsnew-10-1-5-' + key), '');
  }
