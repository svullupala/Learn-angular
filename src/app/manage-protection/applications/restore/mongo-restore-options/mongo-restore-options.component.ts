...
@Component({
  selector: 'mongo-restore-options',
  templateUrl: 'mongo-restore-options.component.html'
})

export class MongoRestoreOptionsComponent extends ApplicationOptionsPage<ApplicationSubOptionModel>
  implements OnInit {
