...
@Component({
  selector: 'oracle-backup-options',
  templateUrl: 'oracle-backup-options.component.html',
  styleUrls: ['oracle-backup-options.component.scss']
})

export class OracleBackupOptionsComponent extends
