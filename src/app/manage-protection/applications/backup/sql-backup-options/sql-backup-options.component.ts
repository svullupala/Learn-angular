...
@Component({
  selector: 'sql-backup-options',
  templateUrl: 'sql-backup-options.component.html',
  styleUrls: ['sql-backup-options.component.scss'],
})

export class SqlBackupOptionsComponent extends
  ...
  onParallelClick() {
    this.model.dbFilesForParallelStreams = 'MULTIPLE_FILES';
  }

  onSequenceClick() {
    this.model.dbFilesForParallelStreams = 'SINGLE_FILE';
  }
