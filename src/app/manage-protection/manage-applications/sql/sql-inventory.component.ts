...
@Component({
  selector: 'sql-inventory',
  templateUrl: './sql-inventory.component.html',
  styleUrls: ['./sql-inventory.component.scss'],
})
export class SqlInventoryComponent {
  ...
  private applicationType: string = 'sql';
