...
@Component({
  selector: 'mongo-inventory',
  templateUrl: './mongo-inventory.component.html',
  styleUrls: ['./mongo-inventory.component.scss'],
})
export class MongoInventoryComponent {
  ...
  private applicationType: string = 'mongo';
