...
@JsonObject
export class DefineEditScheduleModel {
  ...
  public policyOption = new PolicyOptionsModel();
  ...
  public isPreguestScriptServer(): boolean {
    if (this.isPreguestConfigured) {
      if (!this.appserverHrefReady(this.preGuest))
        return false;
      return this.preGuest.appserver.href.includes(DefineEditScheduleModel.SCRIPT_SERVER_URL);
    }
  ...
  public isPostguestScriptServer(): boolean {
    if (this.isPostguestConfigured) {
      if (!this.appserverHrefReady(this.postGuest))
        return false;
      return this.postGuest.appserver.href.includes(DefineEditScheduleModel.SCRIPT_SERVER_URL);
    }
  ...
  private appserverHrefReady(script): boolean {
