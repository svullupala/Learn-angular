...
@Component({
  selector: 'snapshot-restore-hyperv-summary',
  templateUrl: './snapshot-restore-hyperv-summary.component.html',
  styleUrls: ['../snapshot-restore-hyperv.scss']
})
export class SnapshotRestoreHypervSummaryComponent extends WizardPage<SnapshotRestoreHypervModel> implements OnInit,
  OnDestroy {
