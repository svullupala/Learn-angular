...
@Component({
  selector: 'snapshot-restore-hyperv-snapshot',
  templateUrl: './snapshot-restore-hyperv-snapshot.component.html',
  styleUrls: ['../snapshot-restore-hyperv.scss']
})
export class SnapshotRestoreHypervSnapshotComponent extends WizardPage<SnapshotRestoreHypervModel> implements OnInit {
