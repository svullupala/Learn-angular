...
@Component({
  selector: 'snapshot-restore-hyperv-schedule',
  templateUrl: './snapshot-restore-hyperv-schedule.component.html',
  styleUrls: ['../snapshot-restore-hyperv.scss']
})
export class SnapshotRestoreHypervScheduleComponent extends WizardPage<SnapshotRestoreHypervModel> {
