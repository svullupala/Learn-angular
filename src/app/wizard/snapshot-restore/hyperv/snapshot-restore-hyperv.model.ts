...
export class SnapshotRestoreHypervModel extends WizardModel {

  hypervisorType: string = 'hyperv';
  ...
  clearDatastoreNetwork(): void {
    this.mapDatastorePayload = undefined;
    this.mapNetworkPayload = undefined;
    this.mapSubnetPayload = undefined;
  }
