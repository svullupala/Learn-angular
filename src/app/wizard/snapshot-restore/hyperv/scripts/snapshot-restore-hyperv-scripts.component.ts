...
@Component({
  selector: 'snapshot-restore-hyperv-scripts',
  templateUrl: './snapshot-restore-hyperv-scripts.component.html',
  styleUrls: ['../snapshot-restore-hyperv.scss']
})

export class SnapshotRestoreHypervScriptsComponent extends WizardPage<SnapshotRestoreHypervModel> {
  ...
  private saveOptions(): void {
    ...
    model.scriptsPayload = script.getPersistentJson();
    model.script = script;
  }
}
