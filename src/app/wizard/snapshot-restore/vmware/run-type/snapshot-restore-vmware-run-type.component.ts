...
@Component({
  selector: 'snapshot-restore-vmware-run-type',
  templateUrl: './snapshot-restore-vmware-run-type.component.html',
  styleUrls: ['../snapshot-restore-vmware.scss']
})
export class SnapshotRestoreVmwareRunTypeComponent extends WizardPage<SnapshotRestoreVmwareModel> {
