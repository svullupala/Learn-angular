...
@Component({
  selector: 'snapshot-restore-vmware-scripts',
  templateUrl: './snapshot-restore-vmware-scripts.component.html',
  styleUrls: ['../snapshot-restore-vmware.scss']
})

export class SnapshotRestoreVmwareScriptsComponent extends WizardPage<SnapshotRestoreVmwareModel> {
