...
@Component({
  selector: 'snapshot-restore-vmware-summary',
  templateUrl: './snapshot-restore-vmware-summary.component.html',
  styleUrls: ['../snapshot-restore-vmware.scss']
})
export class SnapshotRestoreVmwareSummaryComponent extends WizardPage<SnapshotRestoreVmwareModel> implements OnInit,
  OnDestroy {
