...
@Component({
  selector: 'snapshot-restore-sql-snapshot',
  templateUrl: './snapshot-restore-sql-snapshot.component.html',
  styleUrls: ['../snapshot-restore-sql.scss']
})
export class SnapshotRestoreSqlSnapshotComponent extends WizardPage<SnapshotRestoreSqlModel>
  implements OnInit {
