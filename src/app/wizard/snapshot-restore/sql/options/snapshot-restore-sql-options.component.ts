...
import {AlertComponent, ErrorHandlerComponent} from 'app/shared/components';
...
@Component({
  selector: 'snapshot-restore-sql-options',
  templateUrl: './snapshot-restore-sql-options.component.html',
  styleUrls: ['../snapshot-restore-sql.scss']
})
export class SnapshotRestoreSqlOptionsComponent extends WizardPage<SnapshotRestoreSqlModel>
  implements OnInit {
