...
@Component({
  selector: 'snapshot-restore-sql-schedule',
  templateUrl: './snapshot-restore-sql-schedule.component.html',
  styleUrls: ['../snapshot-restore-sql.scss']
})
export class SnapshotRestoreSqlScheduleComponent extends WizardPage<SnapshotRestoreSqlModel> {
