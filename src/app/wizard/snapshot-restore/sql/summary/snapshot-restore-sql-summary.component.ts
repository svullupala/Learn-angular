...
@Component({
  selector: 'snapshot-restore-sql-summary',
  templateUrl: './snapshot-restore-sql-summary.component.html',
  styleUrls: ['../snapshot-restore-sql.scss']
})
export class SnapshotRestoreSqlSummaryComponent extends WizardPage<SnapshotRestoreSqlModel> implements OnInit,
  OnDestroy {
