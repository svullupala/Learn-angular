...
@Component({
  selector: 'snapshot-restore-sql-scripts',
  templateUrl: './snapshot-restore-sql-scripts.component.html',
  styleUrls: ['../snapshot-restore-sql.scss']
})
export class SnapshotRestoreSqlScriptsComponent extends WizardPage<SnapshotRestoreSqlModel> {
