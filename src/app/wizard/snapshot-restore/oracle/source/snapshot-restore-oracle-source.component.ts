...
@Component({
  selector: 'snapshot-restore-oracle-source',
  templateUrl: './snapshot-restore-oracle-source.component.html',
  styleUrls: ['../snapshot-restore-oracle.scss']
})
export class SnapshotRestoreOracleSourceComponent extends WizardPage<SnapshotRestoreOracleModel> implements OnInit,
  OnDestroy {
