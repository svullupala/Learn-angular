...
@Component({
  selector: 'snapshot-restore-oracle-run-type',
  templateUrl: './snapshot-restore-oracle-run-type.component.html',
  styleUrls: ['../snapshot-restore-oracle.scss']
})
export class SnapshotRestoreOracleRunTypeComponent extends WizardPage<SnapshotRestoreOracleModel> {
