...
@Component({
  selector: 'snapshot-restore-oracle-destination',
  templateUrl: './snapshot-restore-oracle-destination.component.html',
  styleUrls: ['../snapshot-restore-oracle.scss']
})
export class SnapshotRestoreOracleDestinationComponent extends WizardPage<SnapshotRestoreOracleModel> {
