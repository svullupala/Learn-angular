...
@Component({
  selector: 'snapshot-restore-oracle-snapshot',
  templateUrl: './snapshot-restore-oracle-snapshot.component.html',
  styleUrls: ['../snapshot-restore-oracle.scss']
})
export class SnapshotRestoreOracleSnapshotComponent extends WizardPage<SnapshotRestoreOracleModel>
  implements OnInit {
