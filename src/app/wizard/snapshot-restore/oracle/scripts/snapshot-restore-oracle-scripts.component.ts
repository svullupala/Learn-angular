...
@Component({
  selector: 'snapshot-restore-oracle-scripts',
  templateUrl: './snapshot-restore-oracle-scripts.component.html',
  styleUrls: ['../snapshot-restore-oracle.scss']
})
export class SnapshotRestoreOracleScriptsComponent extends WizardPage<SnapshotRestoreOracleModel> {
