...
@Component({
  selector: 'snapshot-restore-oracle-options',
  templateUrl: './snapshot-restore-oracle-options.component.html',
  styleUrls: ['../snapshot-restore-oracle.scss']
})
export class SnapshotRestoreOracleOptionsComponent extends WizardPage<SnapshotRestoreOracleModel>
  implements OnInit {
