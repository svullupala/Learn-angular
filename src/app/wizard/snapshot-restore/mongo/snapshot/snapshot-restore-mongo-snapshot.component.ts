...
import {ApplicationRestoreSelectionTableComponent} from 'app/manage-protection/applications/restore/application-restore-selection-table/application-restore-selection-table.component';
...
@Component({
  selector: 'snapshot-restore-mongo-snapshot',
  templateUrl: './snapshot-restore-mongo-snapshot.component.html',
  styleUrls: ['../snapshot-restore-mongo.scss']
})
export class SnapshotRestoreMongoSnapshotComponent extends WizardPage<SnapshotRestoreMongoModel>
  implements OnInit {
