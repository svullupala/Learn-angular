...
@Component({
  selector: 'snapshot-restore-mongo-options',
  templateUrl: './snapshot-restore-mongo-options.component.html',
  styleUrls: ['../snapshot-restore-mongo.scss']
})
export class SnapshotRestoreMongoOptionsComponent extends WizardPage<SnapshotRestoreMongoModel>
  implements OnInit {
