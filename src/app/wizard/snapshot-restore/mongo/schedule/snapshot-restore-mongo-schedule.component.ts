...
@Component({
  selector: 'snapshot-restore-mongo-schedule',
  templateUrl: './snapshot-restore-mongo-schedule.component.html',
  styleUrls: ['../snapshot-restore-mongo.scss']
})
export class SnapshotRestoreMongoScheduleComponent extends WizardPage<SnapshotRestoreMongoModel> {
