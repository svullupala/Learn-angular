...
@Component({
  selector: 'snapshot-restore-mongo-run-type',
  templateUrl: './snapshot-restore-mongo-run-type.component.html',
  styleUrls: ['../snapshot-restore-mongo.scss']
})
export class SnapshotRestoreMongoRunTypeComponent extends WizardPage<SnapshotRestoreMongoModel> {
