...
@Component({
  selector: 'snapshot-restore-mongo-summary',
  templateUrl: './snapshot-restore-mongo-summary.component.html',
  styleUrls: ['../snapshot-restore-mongo.scss']
})
export class SnapshotRestoreMongoSummaryComponent extends WizardPage<SnapshotRestoreMongoModel> implements OnInit,
  OnDestroy {
