...
@Component({
  selector: 'snapshot-restore-awsec2-snapshot',
  templateUrl: './snapshot-restore-awsec2-snapshot.component.html',
  styleUrls: ['../snapshot-restore-awsec2.scss']
})
export class SnapshotRestoreAwsec2SnapshotComponent extends WizardPage<SnapshotRestoreAwsec2Model> implements OnInit {
