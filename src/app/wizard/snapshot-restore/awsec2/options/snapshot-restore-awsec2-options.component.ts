...
@Component({
  selector: 'snapshot-restore-awsec2-options',
  templateUrl: './snapshot-restore-awsec2-options.component.html',
  styleUrls: ['../snapshot-restore-awsec2.scss']
})
export class SnapshotRestoreAwsec2OptionsComponent extends WizardPage<SnapshotRestoreAwsec2Model>
  implements OnInit {
  ...
  ngOnInit(): void {
    let me = this;
    me.model.options.streaming = me.model.runType !== 'test';
  ...
  public onActive(param: WizardPageEventParam, firstTime?: boolean): void {
    ...
    this.model.options.streaming = this.model.runType !== 'test';
    me.formValues =
