...
@Component({
  selector: 'snapshot-restore-awsec2-schedule',
  templateUrl: './snapshot-restore-awsec2-schedule.component.html',
  styleUrls: ['../snapshot-restore-awsec2.scss']
})
export class SnapshotRestoreAwsec2ScheduleComponent extends WizardPage<SnapshotRestoreAwsec2Model> {
