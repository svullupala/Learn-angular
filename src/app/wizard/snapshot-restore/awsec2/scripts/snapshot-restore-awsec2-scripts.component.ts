...
@Component({
  selector: 'snapshot-restore-awsec2-scripts',
  templateUrl: './snapshot-restore-awsec2-scripts.component.html',
  styleUrls: ['../snapshot-restore-awsec2.scss']
})

export class SnapshotRestoreAwsec2ScriptsComponent extends WizardPage<SnapshotRestoreAwsec2Model> {
