...
@Component({
  selector: 'snapshot-restore-awsec2-source',
  templateUrl: './snapshot-restore-awsec2-source.component.html',
  styleUrls: ['../snapshot-restore-awsec2.scss']
})
export class SnapshotRestoreAwsec2SourceComponent extends WizardPage<SnapshotRestoreAwsec2Model> implements OnInit,
  OnDestroy {
  ...
  ngOnInit(): void {
    ...
    me.transSub = me.translate.get([
      ...
      .subscribe((resource: Object) => {
        ...
        me.views[0].name = resource['awsec2.textInstances'];
        me.views[1].name = resource['awsec2.textTags'];
      });
  }
