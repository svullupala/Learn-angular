...
@Component({
  selector: 'snapshot-restore-kubernetes-destination',
  templateUrl: './snapshot-restore-kubernetes-destination.component.html',
  styleUrls: ['../snapshot-restore-kubernetes.scss']
})
export class SnapshotRestoreKubernetesDestinationComponent extends WizardPage<SnapshotRestoreKubernetesModel> {
