...
@Component({
  selector: 'snapshot-restore-kubernetes-schedule',
  templateUrl: './snapshot-restore-kubernetes-schedule.component.html',
  styleUrls: ['../snapshot-restore-kubernetes.scss']
})
export class SnapshotRestoreKubernetesScheduleComponent extends WizardPage<SnapshotRestoreKubernetesModel> {
