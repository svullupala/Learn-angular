...
@Component({
  selector: 'snapshot-restore-kubernetes-options',
  templateUrl: './snapshot-restore-kubernetes-options.component.html',
  styleUrls: ['../snapshot-restore-kubernetes.scss']
})
export class SnapshotRestoreKubernetesOptionsComponent extends WizardPage<SnapshotRestoreKubernetesModel>
  implements OnInit {
