...
@Component({
  selector: 'snapshot-restore-kubernetes-summary',
  templateUrl: './snapshot-restore-kubernetes-summary.component.html',
  styleUrls: ['../snapshot-restore-kubernetes.scss']
})
export class SnapshotRestoreKubernetesSummaryComponent extends WizardPage<SnapshotRestoreKubernetesModel> implements OnInit,
  OnDestroy {
