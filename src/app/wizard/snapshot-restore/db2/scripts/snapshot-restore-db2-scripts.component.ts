...
@Component({
  selector: 'snapshot-restore-db2-scripts',
  templateUrl: './snapshot-restore-db2-scripts.component.html',
  styleUrls: ['../snapshot-restore-db2.scss']
})
export class SnapshotRestoreDb2ScriptsComponent extends WizardPage<SnapshotRestoreDb2Model> {
