...
@Component({
  selector: 'snapshot-restore-db2-summary',
  templateUrl: './snapshot-restore-db2-summary.component.html',
  styleUrls: ['../snapshot-restore-db2.scss']
})
export class SnapshotRestoreDb2SummaryComponent extends WizardPage<SnapshotRestoreDb2Model> implements OnInit,
  OnDestroy {
