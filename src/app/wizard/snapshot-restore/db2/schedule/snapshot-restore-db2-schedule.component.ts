...
@Component({
  selector: 'snapshot-restore-db2-schedule',
  templateUrl: './snapshot-restore-db2-schedule.component.html',
  styleUrls: ['../snapshot-restore-db2.scss']
})
export class SnapshotRestoreDb2ScheduleComponent extends WizardPage<SnapshotRestoreDb2Model> {
