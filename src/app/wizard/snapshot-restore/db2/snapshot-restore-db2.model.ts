...
export class SnapshotRestoreDb2Model extends WizardModel {
  ...
  defaultMappingsValueForProdOL: object;
  optionValue: object;
  destinationValue: object;
  triggerValue: object;
  scheduleName: string;
  originalLocation: boolean = false;
  targetLocation: string = 'alternate';
  dateRange: Date[];
