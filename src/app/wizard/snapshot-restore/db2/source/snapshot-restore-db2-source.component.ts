...
@Component({
  selector: 'snapshot-restore-db2-source',
  templateUrl: './snapshot-restore-db2-source.component.html',
  styleUrls: ['../snapshot-restore-db2.scss']
})
export class SnapshotRestoreDb2SourceComponent extends WizardPage<SnapshotRestoreDb2Model> implements OnInit,
  OnDestroy {
  ...
  set hasMultipleVersions(value: boolean) {
    this.model.hasMultipleVersions = value;
  }
