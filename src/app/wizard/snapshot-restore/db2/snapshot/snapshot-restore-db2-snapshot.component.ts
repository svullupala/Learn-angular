...
@Component({
  selector: 'snapshot-restore-db2-snapshot',
  templateUrl: './snapshot-restore-db2-snapshot.component.html',
  styleUrls: ['../snapshot-restore-db2.scss']
})
export class SnapshotRestoreDb2SnapshotComponent extends WizardPage<SnapshotRestoreDb2Model>
  implements OnInit {
