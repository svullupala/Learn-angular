...
@Component({
  ...
  templateUrl: './snapshot-restore-exchonline-options.component.html',
  styleUrls: ['../snapshot-restore-exchonline.scss']
})
export class SnapshotRestoreExchOnlineOptionsComponent extends WizardPage<SnapshotRestoreExchOnlineModel>
  implements OnInit {
