...
@Component({
  selector: 'snapshot-restore-exch-scripts',
  templateUrl: './snapshot-restore-exchonline-scripts.component.html',
  styleUrls: ['../snapshot-restore-exchonline.scss']
})
export class SnapshotRestoreExchOnlineScriptsComponent extends WizardPage<SnapshotRestoreExchOnlineModel> {
