...
@Component({
  selector: 'snapshot-restore-exch-schedule',
  templateUrl: './snapshot-restore-exchonline-schedule.component.html',
  styleUrls: ['../snapshot-restore-exchonline.scss']
})
export class SnapshotRestoreExchOnlineScheduleComponent extends WizardPage<SnapshotRestoreExchOnlineModel> {
