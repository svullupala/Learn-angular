...
@Component({
  ...
  templateUrl: './snapshot-restore-exchonline-run-type.component.html',
  styleUrls: ['../snapshot-restore-exchonline.scss']
})
export class SnapshotRestoreExchOnlineRunTypeComponent extends WizardPage<SnapshotRestoreExchOnlineModel>
  ...
  private initMappingPaths(): void {
    let me = this;
    if (!me.isIaType() && me.restoreMappingTable && me.model.runType === 'production')
