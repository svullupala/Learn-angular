...
@Component({
  selector: 'snapshot-restore-exch-source',
  templateUrl: './snapshot-restore-exch-source.component.html',
  styleUrls: ['../snapshot-restore-exch.scss']
})
export class SnapshotRestoreExchSourceComponent extends WizardPage<SnapshotRestoreExchModel> implements OnInit,
  OnDestroy {
