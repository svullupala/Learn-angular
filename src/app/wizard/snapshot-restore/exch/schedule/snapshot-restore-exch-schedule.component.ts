...
@Component({
  ...
  templateUrl: './snapshot-restore-exch-schedule.component.html',
  styleUrls: ['../snapshot-restore-exch.scss']
})
export class SnapshotRestoreExchScheduleComponent extends WizardPage<SnapshotRestoreExchModel> {
