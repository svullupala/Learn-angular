...
@Component({
  selector: 'snapshot-restore-exch-snapshot',
  templateUrl: './snapshot-restore-exch-snapshot.component.html',
  styleUrls: ['../snapshot-restore-exch.scss']
})
export class SnapshotRestoreExchSnapshotComponent extends WizardPage<SnapshotRestoreExchModel>
  implements OnInit {
