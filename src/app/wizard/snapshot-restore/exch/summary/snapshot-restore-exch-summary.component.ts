...
@Component({
  ...
  templateUrl: './snapshot-restore-exch-summary.component.html',
  styleUrls: ['../snapshot-restore-exch.scss']
})
export class SnapshotRestoreExchSummaryComponent extends WizardPage<SnapshotRestoreExchModel> implements OnInit,
  OnDestroy {
