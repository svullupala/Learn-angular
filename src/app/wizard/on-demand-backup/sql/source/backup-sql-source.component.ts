...
@Component({
  selector: 'backup-sql-source',
  templateUrl: './backup-sql-source.component.html',
  styleUrls: ['../backup-sql.scss']
})

export class BackupSqlSourceComponent extends WizardPage<BackupSqlModel> implements OnInit {
