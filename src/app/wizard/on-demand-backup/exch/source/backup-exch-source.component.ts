...
@Component({
  selector: 'backup-exch-source',
  templateUrl: './backup-exch-source.component.html',
  styleUrls: ['../backup-exch.scss']
})

export class BackupExchSourceComponent extends WizardPage<BackupExchModel> implements OnInit {
