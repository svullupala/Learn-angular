...
@Component({
  selector: 'backup-exch-select-sla',
  templateUrl: './backup-exch-select-sla.component.html',
  styleUrls: ['../backup-exch.scss'],
  providers: [SlapolicyService]
})
export class BackupExchSelectSlaComponent extends WizardPage<BackupExchModel> implements OnInit {
