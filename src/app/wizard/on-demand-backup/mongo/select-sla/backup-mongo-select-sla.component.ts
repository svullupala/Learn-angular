...
@Component({
  selector: 'backup-mongo-select-sla',
  templateUrl: './backup-mongo-select-sla.component.html',
  styleUrls: ['../backup-mongo.scss'],
  providers: [SlapolicyService]
})
export class BackupMongoSelectSlaComponent extends WizardPage<BackupMongoModel> implements OnInit {
