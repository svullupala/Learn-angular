...
@Component({
  selector: 'backup-mongo-source',
  templateUrl: './backup-mongo-source.component.html',
  styleUrls: ['../backup-mongo.scss']
})

export class BackupMongoSourceComponent extends WizardPage<BackupMongoModel> implements OnInit {
