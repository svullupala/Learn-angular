...
@Component({
  selector: 'backup-hyperv-select-sla',
  templateUrl: './backup-hyperv-select-sla.component.html',
  styleUrls: ['../backup-hyperv.scss'],
  providers: [SlapolicyService]
})
export class BackupHypervSelectSlaComponent extends WizardPage<BackupHypervModel> implements OnInit {
