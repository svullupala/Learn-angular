...
@Component({
  selector: 'backup-kubernetes-select-sla',
  templateUrl: './backup-kubernetes-select-sla.component.html',
  styleUrls: ['../backup-kubernetes.scss'],
  providers: [SlapolicyService]
})
export class BackupKubernetesSelectSlaComponent extends WizardPage<BackupKubernetesModel> implements OnInit {
