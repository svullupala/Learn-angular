...
@Component({
  selector: 'backup-oracle-select-sla',
  templateUrl: './backup-oracle-select-sla.component.html',
  styleUrls: ['../backup-oracle.scss'],
  providers: [SlapolicyService]
})
export class BackupOracleSelectSlaComponent extends WizardPage<BackupOracleModel> implements OnInit {
