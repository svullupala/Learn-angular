...
@Component({
  selector: 'backup-oracle-source',
  templateUrl: './backup-oracle-source.component.html',
  styleUrls: ['../backup-oracle.scss']
})

export class BackupOracleSourceComponent extends WizardPage<BackupOracleModel> implements OnInit {
