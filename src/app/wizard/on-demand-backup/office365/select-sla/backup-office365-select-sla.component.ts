...
@Component({
  selector: 'backup-office365-select-sla',
  templateUrl: './backup-office365-select-sla.component.html',
  styleUrls: ['../backup-office365.scss'],
  providers: [SlapolicyService]
})
export class BackupOffice365SelectSlaComponent extends WizardPage<BackupOffice365Model> implements OnInit {
