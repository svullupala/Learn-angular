...
@Component({
  selector: 'backup-db2-source',
  templateUrl: './backup-db2-source.component.html',
  styleUrls: ['../backup-db2.scss']
})

export class BackupDb2SourceComponent extends WizardPage<BackupDb2Model> implements OnInit {
